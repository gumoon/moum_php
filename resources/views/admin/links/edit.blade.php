...
function submitUpdateLink()
{
	...
	$("#updateLink").ajaxSubmit(options);
	return false;
}

$(document).ready(function(){
	$("#image_url").on("change", changeFile);
	$("#updateLink").submit(submitUpdateLink);
});
</script>
@endsection
        		...
        		<div class="panel panel-default">
        			...
        			<div class="panel-body">
        				<div class="row col-lg-12">
	                        <div class="form-group" id="nationdiv">
								...
								<select class="form-control" id="nation_id" name="nation_id">
									...
									<option value="0" @if($link->nation_id == 0)selected @endif>中国</option>
									<option value="1" @if($link->nation_id == 1)selected @endif>韩国</option>
								</select>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group" id="namediv">
									<label>网址名称</label>
									<input type="text" id="name" name="name" class="form-control" placeholder="" value="{{$link->name}}">
							...
							<div class="col-lg-6">
								<div class="form-group" id="namediv">
									<label>网址URL</label>
									<input type="text" id="url" name="url" class="form-control" placeholder="" value="{{$link->url}}">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<img src="{{$link->icon_src}}" alt="{{$link->icon}}" id="image_url1" style="width: 100px; height: 100px">
